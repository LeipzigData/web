...
<head>
	...
	<script src="http://trunk.simile-widgets.org/exhibit/api/extensions/calendar/calendar-extension.js"></script>
	<!-- importing Map View -->
            ...
            <tr>
                ...
                <td>
					<div ex:role="viewPanel">
						...
						<div ex:role="view" ex:label="OSM-Map"
							ex:viewClass="OLMap" 
							ex:lat = ".lat"
							ex:lng = ".long"
							ex:type="osm"
							ex:osmURL="http://a.tile.openstreetmap.org/${z}/${x}/${y}.png"
							ex:colorKey=".label">
						</div>						   
						<div ex:role="view" 
